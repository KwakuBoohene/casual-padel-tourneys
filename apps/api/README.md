...
Fastify + Prisma API for Casual Padel Tourneys. Owns tournament lifecycle (Americano / Mexicano / Regular), auth, King of the Court (KOH), and realtime scoreboard updates.
